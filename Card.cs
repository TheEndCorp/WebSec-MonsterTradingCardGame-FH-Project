...
public List<Card> OpenCardPack(int Userid)
    ...
    private static string[] MonsterNames = { "Goblin", "Orc", "Dragon", "Knight", "Elf", "Dwarf", "Giant", "Kraken", "Wizard", "FireElf" };
    private static string[] SpellNames = { "Fireball", "Heal", "Lightning", "WaterBall" };
